 ...
 * @Path: com.jack.netty.conf.utilVfsUtils.java
 * @Create By Jack
 * @Create In 2016年8月16日 上午10:08:35
 * TODO
 */
...
import com.jack.netty.conf.exception.NestedIOException;
import com.jack.netty.util.ReflectionUtils;
...
public abstract class VfsUtils {
    ...
    static {
        ...
        try {
            ...
            VIRTUAL_FILE_METHOD_VISIT = ReflectionUtils
                    .findMethod(virtualFile, "visit", VIRTUAL_FILE_VISITOR_INTERFACE);

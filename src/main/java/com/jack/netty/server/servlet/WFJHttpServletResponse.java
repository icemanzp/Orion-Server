 ...
 * @Path: com.jack.netty.server.servletWFJHttpServletResponse.java
 * @Create By Jack
 * @Create In 2016年4月14日 下午6:56:16
 * TODO
 */
...
/**
 * @Class Name WFJHttpServletResponse
 * @Author Jack
 * @Create In 2016年4月14日
 */
public class WFJHttpServletResponse implements HttpServletResponse {
    ...
    public PrintWriter getWriter() throws UnsupportedEncodingException {
        ...
        if (this.writer == null) {
            Writer targetWriter = (this.characterEncoding != null ?
                    new OutputStreamWriter(this.content, this.characterEncoding) : new OutputStreamWriter(
                    this.content));

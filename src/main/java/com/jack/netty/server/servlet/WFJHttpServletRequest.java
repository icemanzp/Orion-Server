 ...
 * @Path: com.jack.netty.server.servletWFJHttpServletRequest.java
 * @Create By Jack
 * @Create In 2016年4月14日 下午7:05:08
 * TODO
 */
...
import com.jack.netty.server.servlet.session.WFJHttpSession;
import com.jack.netty.util.Assert;
import com.jack.netty.util.LinkedCaseInsensitiveMap;
...
/**
 * @Class Name WFJHttpServletRequest
 * @Author Jack
 * @Create In 2016年4月14日
 */
public class WFJHttpServletRequest implements HttpServletRequest {
    ...
    private static final ServletInputStream EMPTY_SERVLET_INPUT_STREAM =
            new DelegatingServletInputStream(new InputStream() {
    ...
    private WFJAsyncContext asyncContext;
     ...
     * @see #MockHttpServletRequest(ServletContext, String, String)
     */
    public WFJHttpServletRequest(String method, String requestURI) {
     ...
     * @see #MockHttpServletRequest(ServletContext, String, String)
     */
    public WFJHttpServletRequest(ServletContext servletContext) {
        this(servletContext, "", "");
    }
     ...
     */
    public WFJHttpServletRequest(ServletContext servletContext, String method, String requestURI) {
    ...
    public AsyncContext startAsync(ServletRequest request, ServletResponse response) {
        ...
        this.asyncContext = new WFJAsyncContext(request, response);
    ...
    public void setAsyncContext(WFJAsyncContext asyncContext) {
    ...
    public boolean isUserInRole(String role) {
        return (this.userRoles.contains(role) || (this.servletContext instanceof WFJServletContext &&
                ((WFJServletContext) this.servletContext).getDeclaredRoles().contains(role)));
    }
    ...
    public StringBuffer getRequestURL() {
        ...
        if (this.serverPort > 0
                && ((HTTP.equalsIgnoreCase(this.scheme) && this.serverPort != 80) || (HTTPS
    ...
    public void setSession(HttpSession session) {
        ...
        if (session instanceof WFJHttpSession) {
            WFJHttpSession mockSession = ((WFJHttpSession) session);
            mockSession.access();
        }
    }
    ...
    public HttpSession getSession(boolean create) {
        ...
        if (this.session instanceof WFJHttpSession && ((WFJHttpSession) this.session).isInvalid()) {
            this.session = null;
        }
        // Create new session if necessary.
        if (this.session == null && create) {
            this.session = new WFJHttpSession(this.servletContext);
        }
        return this.session;
    }
    ...
    public String changeSessionId() {
        ...
        if (this.session instanceof WFJHttpSession) {
            return ((WFJHttpSession) session).changeSessionId();
        }

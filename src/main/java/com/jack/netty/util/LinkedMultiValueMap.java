 ...
 * @Path: com.jack.netty.utilLinkedMultiValueMap.java
 * @Create By Jack
 * @Create In 2016年8月16日 上午9:43:46
 * TODO
 */
...
/**
 * @Class Name LinkedMultiValueMap
 * @Author Jack
...
public class LinkedMultiValueMap<K, V> implements MultiValueMap<K, V>, Serializable {
     ...
     */
    private static final long serialVersionUID = -4928590054013494624L;

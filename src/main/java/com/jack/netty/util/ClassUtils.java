 ...
 * @Path: com.jack.netty.utilClassUtils.java
 * @Create By Jack
 * @Create In 2016年8月16日 上午9:27:45
 * TODO
 */
...
public abstract class ClassUtils {
    ...
    public static <T> T instantiateClass(Class<T> clazz) throws Exception {
        ...
        if (clazz.isInterface()) {
            throw new ClassNotFoundException(clazz.toString() + "Specified class is an interface");
        }
        try {
            return instantiateClass(clazz.getDeclaredConstructor());
        } catch (NoSuchMethodException ex) {
            throw new ClassNotFoundException(clazz.toString() + "No default constructor found", ex);
        }
    }
    ...
    public static <T> T instantiateClass(Class<?> clazz, Class<T> assignableTo) throws Exception {
    ...
    public static <T> T instantiateClass(Constructor<T> ctor, Object... args) throws Exception {
        ...
        try {
            ...
            throw new ClassNotFoundException(ctor.getDeclaringClass() + "Is it an abstract class?", ex);
        } catch (IllegalAccessException ex) {
            throw new ClassNotFoundException(ctor.getDeclaringClass() + "Is the constructor accessible?", ex);
        } catch (IllegalArgumentException ex) {
            throw new ClassNotFoundException(ctor.getDeclaringClass() + "Illegal arguments for constructor", ex);
        } catch (InvocationTargetException ex) {
            throw new ClassNotFoundException(ctor.getDeclaringClass() + "Constructor threw exception",
